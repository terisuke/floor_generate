...
# 重要: 実行前に patch_diffusers.py が正しく適用されていることを確認してください
# src/training/lora_trainer.py と src/inference/generator.py の先頭に
# import patch_diffusers と patch_diffusers.apply_patches() が追加されていることを確認
